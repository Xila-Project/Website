...
const referenceSidebar: DefaultTheme.SidebarItem[] = [
  {
    text: "🌟 Reference",
    items: [
      { text: "🖥️ Host", link: "/host-reference" },
...
const guideSidebar: DefaultTheme.SidebarItem[] = [
  {
    ...
    collapsed: false,
    items: [
      { text: "🖥️ Use (host)", link: "/guide/get_started/use_host" },
    ...
    items: [
      {
        ...
        items: [
          ...
          { text: "🖼️ Graphics", link: "/guide/architecture/modules/graphics" },
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "✨ Bootsplash",
            link: "/guide/architecture/crates/bootsplash",
          },
          ...
          {
            text: "📁 Little FS",
            link: "/guide/architecture/crates/little_fs",
          },
          {
            text: "🎛️ Peripherals",
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "⚡ Espressif",
            link: "/guide/architecture/drivers/espressif",
          },
          { text: "🖥️ Native", link: "/guide/architecture/drivers/native" },
